...
const GROUPS: { title: string; items: Item[] }[] = [
  {
    ...
    // Gong as the sources, section 4.2 starts a PMM's day with an alert, and the
    // questionnaire lists "less manual effort for the team" as a goal.
    //
    // The route still works and is still the clearest way to demonstrate the
    // pipeline end to end, and it is the only way in for a signal Crayon has not
