  ...
  return (
    <div className="relative isolate">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
        <div className="animate-breathe absolute left-1/2 top-1/2 h-[420px] w-[600px] rounded-full bg-blue-500/25 blur-3xl" />
      </div>
      ...
      <form onSubmit={handleSubmit} className="w-full">
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-3 shadow-sm transition-colors focus-within:border-blue-400 focus-within:ring-2 focus-within:ring-blue-500/20">
          <textarea
            ref={taRef}
          ...
          <div className="mt-2 flex items-center gap-2">
            <select
              ...
              aria-label="Source"
              className="rounded-lg border border-gray-200 bg-gray-50 px-2 py-1 text-xs text-gray-600 outline-none focus:border-blue-400"
            >
              {SOURCE_TYPES.map((t) => (
            ...
            <input
              ...
              className="min-w-0 flex-1 rounded-lg border border-gray-200 bg-gray-50 px-2 py-1 text-xs text-gray-700 outline-none placeholder:text-gray-400 focus:border-blue-400"
            />
            <button
              type="submit"
              disabled={submitting}
              aria-label="Submit signal"
              className="ml-auto flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-blue-600 text-white transition-colors hover:bg-blue-700 disabled:opacity-50"
            >
              {submitting ? (
