...
<tr><td style="padding:16px 28px 4px 28px;"><p style="margin:0;font-size:14px;line-height:22px;color:#4b5563;">The agent has prepared tailored updates for <b>Leadership, Product, Marketing, and Sales &amp; CS</b>. They are waiting for your review and approval.</p></td></tr>
...
<tr><td style="background:#fafafa;border-top:1px solid #eee;padding:14px 28px;"><span style="font-size:11px;color:#9ca3af;">Compete Agent for Litera · You are receiving this because you are the designated reviewer (PMM).</span></td></tr>
  ...
  const text = `New competitive signal awaiting review\n\nCompetitor: ${competitor}\nSource: Crayon${
    excerpt ? `\nSignal: ${excerpt}` : ''
  }\n\nThe agent has prepared tailored updates for Leadership, Product, Marketing, and Sales & CS. They await your review and approval.\n\nReview Signal: ${reviewUrl}\n\nNothing is sent to any team until you approve it.`;
